    ...
    <div className="min-h-screen bg-stone-950 text-stone-100 font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-stone-800 pb-6">
          ...
          {/* Type Toggle Tabs */}
          <div className="bg-stone-900 border border-stone-800 p-1 rounded-xl flex items-center gap-1 self-stretch sm:self-auto">
            <button
              onClick={() => setTipo('LIVRO')}
              className={`flex-1 sm:flex-none px-5 py-2 rounded-lg font-bold text-xs flex items-center justify-center gap-2 transition-all ${
                tipo === 'LIVRO'
        ...
        {loading ? (
          ...
          <div className="bg-stone-900 border border-stone-800 rounded-xl p-12 text-center text-stone-400 space-y-3">
            ...
            <p className="font-serif text-base text-stone-200">Nenhum conteúdo encontrado com os filtros selecionados.</p>
            <button
              onClick={() => { setQuery(''); setCategoria(''); setNivel(''); setGratuito(false); }}
